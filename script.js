...
const translations = {
  id: {
    ...
    "btn-view-steps": "Lihat Langkah Flashing",
    "download-pill": "GOOGLE DRIVE FOLDER",
    "download-title": "Pusat Unduhan Berkas (Downloads)",
    "download-desc": "Seluruh berkas yang dibutuhkan (Recovery <code>vendor_boot.img</code>, paket ZIP ROM, dan berkas pendukung) telah saya sediakan dalam satu folder Google Drive terpadu berikut:",
    "download-contents-desc": "Isi folder: vendor_boot.img (Recovery), Infinity-X ROM ZIP, dan kelengkapan terkait.",
    "btn-open-drive": "Buka Folder Google Drive",
  ...
  en: {
    ...
    "btn-view-steps": "View Flashing Steps",
    "download-pill": "GOOGLE DRIVE FOLDER",
    "download-title": "Download Center",
    "download-desc": "All essential files (bundled <code>vendor_boot.img</code> recovery, ROM ZIP package, and supporting files) are available in the following unified Google Drive folder:",
    "download-contents-desc": "Folder contents: vendor_boot.img (Recovery), Infinity-X ROM ZIP, and related files.",
    "btn-open-drive": "Open Google Drive Folder",
